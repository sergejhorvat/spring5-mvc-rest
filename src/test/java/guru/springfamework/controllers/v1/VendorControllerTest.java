...
@WebMvcTest(controllers = {VendorController.class}) //  bring up a Spring context with controller
public class VendorControllerTest{

    // a bit different approach for initialization mocks than before.
    @MockBean //provided by Spring Context - tells Mockito and Spring to inject mock into test
